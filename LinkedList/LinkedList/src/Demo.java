...
public class Demo {
    public static void main(String[] args){
        ...
        // ith LinkedList must tell the 
        //position to add/remove  (1)/(4)
    ...
    private static boolean addInOrder(
            LinkedList<String>linkedList, String newCity){
        ...
        while(stringListIterator.hasNext()){
            ...
            if(comparison == 0){
                System.out.println(newCity + 
                        " is already included as a destination.");
                return false;
    ...
    private static void visit(LinkedList cities){
        ...
        if (cities.isEmpty()){
            System.out.println("No cities in itemerary");
            return;
        }else{
