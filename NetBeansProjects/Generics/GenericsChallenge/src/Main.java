...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        League<FootballPlayer, Team> footballLeague = new League<>("AFL");
        ...
        rawTeam.addTeamPlayer(beckham); // unchecked warning
        rawTeam.addTeamPlayer(pat);     // unchecked warning

        footballLeague.add(rawTeam);     // unchecked warning

        League<FootballPlayer, Team> rawLeague = new League<>("Raw");
