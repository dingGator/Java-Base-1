...
public class Hamburger {
   ...
   public void addHamburgerAddition4(String name,
    ...
    /*
    public double nameAdd(String baseAdd){
        
      //  System.out.println(" a Base Addition = "+ baseAdd);
        switch (baseAdd){
              case "lettuce":
                  System.out.println(" Add = lettuce  price: 0.50");
                
                  break;
              case "tomato":
                  System.out.println(" Add = tomato   price: 1.00");
                  break;
              case "carrot":
                  System.out.println(" Add = carrot   price: 0.50");
                
                  break;
              case "pickle":
                  System.out.println(" Add = pickle   price: 1.50");
                  break;
        }
      return grandTotal;
          }
